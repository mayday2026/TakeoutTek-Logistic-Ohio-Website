                        ...
                        <div class="page-content">
                            <div class="content-nav-full">
                                <div class="page-profile">
                                    <form id="form-profile" action="../includes/lockercode.inc.php" method="post">
                                        ...
                                        <div class="profile-row m-t-15">
                                            <div class="profile-col-md-6">
                                                <label><b>Locker Code:</b> 
                                                        <?php
                                                            if (isset($_SESSION["useruid"])) {
                                                                $sql = "SELECT locker_code FROM account WHERE users_Id='".$_SESSION['userid']."';";
                                                                $result = mysqli_query($conn, $sql);
                                                                $resultCheck = mysqli_num_rows($result);
                                                                if ($resultCheck > 0) {
                                                                    while ($row = mysqli_fetch_assoc($result)){
                                                                        echo $row['locker_code'];
                                                                    }
                                                                }
                                                            }
                                                        ?>
                                        ...
                                        <div class="profile-row button-row">
                                            <div class="profile-col-md-2">
                                                <label></label>
                                                <button type="submit" name="place-order" class="place-order-btn">Place Order</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
